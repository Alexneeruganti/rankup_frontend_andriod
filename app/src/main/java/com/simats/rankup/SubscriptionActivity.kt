...
class SubscriptionActivity : AppCompatActivity(), PurchasesUpdatedListener {
    ...
    companion object {
        ...
        private const val SUBSCRIPTION_SKU = "RANKUP_premium_subscription"
    ...
    private fun navigateToNext() {
        ...
        val nextIntent = if (nextActivityClassName != null) {
            try {
                Intent(this, Class.forName(nextActivityClassName))
            } catch (e: Exception) {
